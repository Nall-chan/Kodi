 ...
 * @example <b>Ohne</b>
 *
 * @method null ExecuteAddon(array $Params)
 * @method null GetAddons(array $Params) Liest die Eigenschaften aller Addons aus.
 * @method array GetAddonDetails(array $Params)
 * @method null SetAddonEnabled(array $Params)
 *
 ...
 * @method null Quit Beendet Kodi.
 *
 * @method null Clean Startet das bereinigen der Datenbank.
 * @method null Export(array $Params) ("options" (string "path" Ziel-Verzeichnis für den Export) (bool "overwrite" Vorhandene Daten überschreiben.) (bool "images" Bilder mit exportieren.)) Exportiert die Audio Datenbank.
 ...
 * @method null GetAlbums(array $Params) Liest einen Teil der Eigenschaften aller Alben aus.
 ...
 * @method null GetArtists(array $Params) Liest einen Teil der Eigenschaften aller Künstler aus.
 * @method null GetGenres(array $Params) Liest einen Teil der Eigenschaften aller Genres aus.
 * @method null GetRecentlyAddedAlbums(array $Params) Liest die Eigenschaften der zuletzt hinzugefügten Alben aus.
 * @method null GetRecentlyAddedSongs(array $Params) Liest die Eigenschaften der zuletzt hinzugefügten Songs aus.
 * @method null GetRecentlyPlayedAlbums(array $Params) Liest die Eigenschaften der zuletzt abgespielten Alben aus.
 * @method null GetRecentlyPlayedSongs(array $Params) Liest die Eigenschaften der zuletzt abgespielten Songs aus.
 ...
 * @method null GetSongs(array $Params) Liest die Eigenschaften aller Songs aus.
 * @method null Scan() Startet das Scannen von PVR-Kanälen oder von Quellen für neue Einträge in der Datenbank.
 * @method null GetFavourites(array $Params) Liest die Eigenschaften aller Favoriten aus.
 ...
 * @method null Up Tastendruck hoch.
 * @method null Down Tastendruck runter.
 * @method null Left Tastendruck links.
 * @method null Right Tastendruck right.
 * @method null Back Tastendruck zurück.
 * @method null ContextMenu Tastendruck Context-Menü.
 * @method null Home Tastendruck Home.
 * @method null Info Tastendruck Info.
 * @method null Select Tastendruck Select.
 * @method null ShowOSD OSD Anzeigen.
 * @method null ShowCodec Codec-Info anzeigen.
 ...
 *
 * @method null GetBroadcasts(array $Params)
 * @method null GetBroadcastDetails(array $Params)
 * @method null GetChannels(array $Params)
 * @method null GetChannelDetails(array $Params)
 * @method null GetChannelGroups(array $Params)
 * @method null GetChannelGroupDetails(array $Params)
 * @method null GetRecordings(array $Params)
 * @method null GetRecordingDetails(array $Params)
 * @method null GetTimers(array $Params)
 * @method null GetTimerDetails(array $Params)
 *
 * @method null GetActivePlayers
 * @method null GetItem(array $Params) (string "playerid" PlayerID) (array "properties" Zu lesende Eigenschaften) Liest die Eigenschaften eines Players aus.
 * @method null GetPlayers
 * @method null GetProperties(array $Params) (string "playerid" PlayerID) (array "properties" Zu lesende Eigenschaften) Liest die Eigenschaften eines Players aus.
 * @method null GoTo(array $Params)
 * @method null Move
 * @method null Open(array $Params)
 * @method null PlayPause(array $Params)
 * @method null Rotate
 * @method null Seek(array $Params)
 * @method null SetAudioStream(array $Params)
 * @method null SetPartymode(array $Params)
 * @method null SetRepeat(array $Params)
 * @method null SetShuffle(array $Params)
 * @method null SetSpeed(array $Params)
 * @method null SetSubtitle(array $Params)
 * @method null Stop(array $Params)
 * @method null Zoom
 *
 * @method null Add(array $Params)
 * @method null Clear(array $Params)
 ...
 * @method null Swap
 *
 * @method null Shutdown Führt einen Shutdown auf Betriebssystemebene aus.
 * @method null Hibernate Führt einen Hibernate auf Betriebssystemebene aus.
 * @method null Suspend Führt einen Suspend auf Betriebssystemebene aus.
 * @method null Reboot Führt einen Reboot auf Betriebssystemebene aus.
 * @method null EjectOpticalDrive Öffnet das Optische Laufwerk.
 ...
 * @method null GetEpisodes(array $Params) Liest die Eigenschaften aller Episoden aus.
 * @method null GetRecentlyAddedEpisodes(array $Params) Liest die Eigenschaften der zuletzt hinzugefügten Episoden aus.
 ...
 * @method null GetMovies(array $Params) Liest die Eigenschaften aller Filme aus.
 * @method null GetRecentlyAddedMovies(array $Params) Liest die Eigenschaften der zuletzt hinzugefügten Filme aus.
 ...
 * @method null GetMovieSets(array $Params)  Liest die Eigenschaften alle Movie-Sets aus.
 ...
 * @method null GetRecentlyAddedMusicVideos(array $Params) Liest die Eigenschaften der zuletzt hinzugefügten Musikvideos aus.
 ...
 * @method null GetTVShows(array $Params) Liest die Eigenschaften alle TV-Serien.
 */
class Kodi_RPC_Data extends stdClass
{
     ...
     * Typ der Daten
     * @access private
     * @var int [Kodi_RPC_Data::EventTyp, Kodi_RPC_Data::ParamTyp, Kodi_RPC_Data::ResultTyp]
     */
    private ?int $Typ;
     ...
     * @param array|object|null $Params [optional] Parameter der Methode
     * @param ?int $Id [optional] Id des RPC-Objektes
     * @return Kodi_RPC_Data
     */
    public function __construct(?string $Namespace = null, ?string $Method = null, array|object|null $Params = null, ?int $Id = null)
    {
        $this->Typ = null;
        $this->Namespace = null;
        $this->Method = null;
